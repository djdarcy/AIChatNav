#!/bin/bash
#
# Install git hooks for aichatnav project
#
...
echo -e "${BLUE}aichatnav Git Hook Installer${NC}"
echo "=========================="
echo ""
...
echo "  - Validate JavaScript syntax"
echo "  - Validate manifest.json"
echo "  - Check for debug/debugger statements"
